...
export async function getParticipantsV2(name, groupId, options = {}) {
  return request('get', `/api/${encodeURIComponent(name)}/groups/${encodeURIComponent(groupId)}/participants/v2`, {
...
export async function getGroups(name, params = {}, options = {}) {
  return request('get', `/api/${encodeURIComponent(name)}/groups`, {
    params,
    timeout: Number(options.timeout || 30000),
    ...(options.signal ? { signal: options.signal } : {})
  });
