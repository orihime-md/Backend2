...
const CATEGORIES = [
  ...
  { key: 'MEDIA', emoji: '🎬', label: 'MEDIA', blurb: 'Stickers, music & more' },
...
const COMMANDS_BY_CATEGORY = {
  ...
  AI: [
    ...
    { name: 'summarize', label: '.summarize', desc: 'Summarize a long message', requiresArg: true, usage: '.summarize (reply to a message, or .summarize <text>)' },
    { name: 'translate', label: '.translate <lang>', desc: 'Translate a message', requiresArg: true, usage: '.translate spanish (reply to a message, or .translate spanish <text>)' }
  ],
  MEDIA: [
    { name: 'sticker', label: '.sticker', desc: 'Reply to an image/video to make a sticker' },
    { name: 'toimg', label: '.toimg', desc: 'Reply to a sticker to convert it to an image' },
    { name: 'play', label: '.play <song>', desc: 'Search & download a song', requiresArg: true, usage: '.play <song name or YouTube link>' }
  ],
  GAMES: [
  ...
  GROUP: [
    ...
    { name: 'warn', label: '.warn @user', desc: 'Warn a member (auto-kick at limit)', requiresArg: true, usage: '.warn @user  (or reply to their message)' },
    { name: 'remindme', label: '.remindme <mins>', desc: 'Set a reminder', requiresArg: true, usage: '.remindme 10 stretch break' }
  ],
  BOT: [
  ...
  ADMIN: [
    ...
    { name: 'antispam', label: '.antispam on/off', desc: 'Mute members who flood messages', toggle: true },
    { name: 'antidelete', label: '.antidelete on/off', desc: 'Resend messages people delete', toggle: true },
    { name: 'badword', label: '.badword add <word>', desc: 'Auto-delete messages with bad words', requiresArg: true, usage: '.badword add word1,word2  •  .badword list  •  .badword remove word' },
    { name: 'warnlimit', label: '.warnlimit <n>', desc: 'Warns before auto-kick', requiresArg: true, usage: '.warnlimit 3' }
  ]
};
